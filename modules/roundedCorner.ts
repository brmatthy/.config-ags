// credit @kotontrion
// https://github.com/kotontrion/dotfiles/blob/main/.config/ags/modules/roundedCorner/index.js

import Widget from "resource:///com/github/Aylur/ags/widget.js";
import Gtk from "gi://Gtk?version=3.0";

export const RoundedCorner = (place: string, props: any) => Widget.DrawingArea({
  ...props,
...
export const RoundedAngleEnd = (place: string, props: any) => Widget.DrawingArea({
  ...props,
  setup: widget => {
    const ratio = 2.0;
